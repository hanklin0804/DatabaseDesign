        ...
        <div className="manage-menu-items-content">
                ...
                <Col xs={12} sm={6} md={4} className="menu-item-col">
                    ...
                    <Card.Body>
                        ...
                        <Form className="edit-form">
                            ...
                            <Button variant="primary" onClick={() => saveItem(index)}>Save</Button>
                        </Form>
                        ) : (
                        <>
          ...
          <Form onSubmit={addItem} className="new-item-form">
            ...
            <Form.Group controlId="formBasicPassword">
              ...
              <Form.Control type="text" value={newItem.price} onChange={e => setNewItem({ ...newItem, price: e.target.value })} />
            </Form.Group>
