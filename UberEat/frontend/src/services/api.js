...
export async function getMenuItems(restaurantId) {
  const response = await instance.get(`/restaurants/${restaurantId}/menu-items`);
  return response.data;
}

// function to create a new menu item for a restaurant
export async function createMenuItem(restaurantId, data) {
  const response = await instance.post(`/restaurants/${restaurantId}/menu-items`, data);
  return response.data;
}

// function to edit a menu item for a restaurant
export async function editMenuItem(restaurantId, itemId, data) {
  const response = await instance.put(`/restaurants/${restaurantId}/menu-items/${itemId}`, data);
  return response.data;
}
